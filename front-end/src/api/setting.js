...
export default {
  ...
  organization: {
    ...
    load(id) {
      return Ajax.get(`/organization/${id}`)
    },
    delete(id) {
    ...
    checkUse(id) {
      return Ajax.get(`/organization/checkUse/${id}`)
    },
    mapping(params) {
      return Ajax.post(`/organization/mapping`, params)
    },
  },
  //科目
  subject: {
    ...
    select(params = {}) {
      return Ajax.get("/subject/select", params)
    },
    load(id) {
  ...
  initialBalance: {
    list(type, orgId) {
      return Ajax.get("/initial-balance?type=" + type + "&orgId=" + orgId)
    },
    load(id) {
  ...
  inventory: {
    login(formData) {
      return Ajax.post("/api/inventory/financial/login", Qs.stringify(formData));
    },
    supplier() {
      return Ajax.get("/api/inventory/financial/supplier");
    },
    materiel() {
      return Ajax.get("/api/inventory/financial/materiel");
    },
    organization() {
      return Ajax.get("/api/inventory/financial/organization");
    },
    order(params) {
      return Ajax.get("/api/inventory/financial/order", params);
    },
    orderDetail(id, params) {
      return Ajax.get("/api/inventory/financial/order/detail/" + id, params);
    }
  }
}
